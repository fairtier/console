  ...
  en: {
    integrations: {
      ...
      google: {
        title: 'Google',
        subtitle:
          'Needed before a Google Sheets source can use “Sign in with Google”. You register the app in your own Google Cloud project, so the consent screen, the usage quota and the review status are yours.',
        ...
        removeConfirm: {
          ...
          body: 'Google Sheets pipelines connected with it will stop refreshing and have to be reconnected. Nothing already loaded into your warehouse is affected.',
          confirm: 'Disconnect',
        },
        toast: {
  ...
  cs: {
    integrations: {
      ...
      google: {
        title: 'Google',
        subtitle:
          'Nutné, než zdroj Google Sheets použije „Přihlásit se přes Google“. Aplikaci registrujete ve vlastním projektu Google Cloud, takže souhlasná obrazovka, kvóta i stav ověření jsou vaše.',
        ...
        removeConfirm: {
          ...
          body: 'Pipeline Google Sheets připojené přes ni se přestanou obnovovat a bude je potřeba připojit znovu. Data už načtená do skladu to neovlivní.',
          confirm: 'Odpojit',
        },
        toast: {
